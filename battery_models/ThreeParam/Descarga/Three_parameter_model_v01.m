...
t_corte = 3800;           % tenerlo en cuenta cuando no haya corte
...
figure(2)
plot(t,c_sp,t,c_sn)
title('Concentraciones en ambos electrodos')
xlabel('Tiempo, t [s]')
ylabel('Concentración [mol*cm^{-3}]')
legend('c_sp','c_sn')
...
% Calculate C-rate
    ...
    SOC = (c_sp/c_smaxp-beta_p0)/(beta_p100-beta_p0);
